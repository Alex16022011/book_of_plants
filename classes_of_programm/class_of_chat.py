...
text = CTkTextbox(master=root, font=('Arial', 20), bg_color='black', fg_color='white', height=70, width = (w - 131), border_color='black', border_width=2)
...
btn_send = CTkButton(master=root, text='➤', fg_color='#3399FF', text_color='white', font=('Arial', 30), height=50, width=20, corner_radius=1000, command=lambda: (send_messages(a := 5), 
                                                                                                                                                                   text.delete('1.0', END)))
